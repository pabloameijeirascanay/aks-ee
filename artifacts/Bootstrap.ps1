...
[System.Environment]::SetEnvironmentVariable('GITHUB_TOKEN', $githubToken,[System.EnvironmentVariableTarget]::Machine)
[System.Environment]::SetEnvironmentVariable('GH_REPO', "${githubAccount}/${githubRepo}",[System.EnvironmentVariableTarget]::Machine)
...
workflow ClientTools_01
        {
            $chocolateyAppList = 'azure-cli,az.powershell,kubernetes-cli,gh,kubernetes-helm'
